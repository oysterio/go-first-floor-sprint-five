...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	meanSpeedMPerS := w.Training.meanSpeed() * KmHInMsec
	return ((CaloriesWeightMultiplier*w.Training.Weight + (math.Pow(meanSpeedMPerS, 2)/(w.Height*CmInM))*
